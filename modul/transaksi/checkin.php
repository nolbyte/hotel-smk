...
<div class="row">
	<div class="box box-warning">
		<div class="box-header with-border">
			<h3 class="box-title">CHECK IN</h3>&nbsp;&nbsp;<small>Pilih kamar yang tersedia</small>
		</div>
		<div class="box-body">
			<?php if(!empty($list)){ ?>
				<div class="row">
					<?php foreach($sql->fetchAll() as $kamar_tersedia){ ?>
						<div class="col-sm-3">
							<div class="small-box bg-green">
								...
								<a class="small-box-footer" href="index.php?mod=transaksi&hal=checkin-add&kamar=<?=$kamar_tersedia['id_kamar']; ?>">Pilih Kamar</a>
							</div>
						</div>
					<?php } ?>
				</div>
			<?php }else{ ?>
				<div class="alert alert-warning">
					<h4>Mohon Maaf</h4>
					Saat ini, tidak ada kamar yang tersedia.
				</div>
			<?php } ?>
		</div>
	</div>
