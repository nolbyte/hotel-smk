...
<div class="row">
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Room Service</h3>&nbsp;&nbsp;<small>Pilih kamar yang akan melakukan pemesanan</small>
		</div>
		<div class="box-body">
			<?php if(!empty($listC)){ ?>			
				<div class="row">
					<?php foreach($sqlt->fetchAll() as $row){ ?>
						<div class="col-sm-3">
							<div class="small-box bg-blue">
								...
								<a class="small-box-footer" href="index.php?mod=transaksi&hal=pesan-layanan-add&id=<?= $row['id_transaksi_kamar']?>">Pilih Kamar</a>
							</div>
						</div>
					<?php } ?>
				</div>	
